...
export default function MobileStep() {
  ...
  const { mobileNumber, status, error } = useAppSelector((s) => s.verification);
    ...
    <div className="step-body">
      ...
      >
        ...
        <p className="step-subtext">
          We'll text a one-time code to confirm this scan is you
        </p>
        ...
        >
          ...
          <input
            ...
            inputMode="numeric"
            onChange={(e) =>
              dispatch(setMobileNumber(e.target.value.replace(/\D/g, "")))
            }
          />
        </div>
      </div>
